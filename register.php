...
<form action="register.php" method="post">
	...
	<p> Phone No: <input type="text" name="phone_no" size="20" maxlength="40" value= "<?php if (isset($_POST['phone_no'])) echo $_POST['phone_no']; ?>" /></p>
	<p>Email Address: <input type="text" name="email" size="20" maxlength="60" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>"  /> </p>
	<p><label>Programme: <?php programme(); ?>
...
<?php
function programme() {
	$Programme = array ('BSE' => 'BSE', 'BIMD' =>  'BIMD', 'BCEM' =>  'BCEM', 'BCSS' =>  'BCSS', 'BNS' =>  'BNS', 'BCE' =>  'BCE',);
