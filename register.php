...
<form action="register.php" method="post">
	...
	<p> Phone Number: <input type="text" name="phone_no" size="20" maxlength="40" value= "<?php if (isset($_POST['phone_no'])) echo $_POST['phone_no']; ?>" /></p>
	<p>Address: <input type="text" name="address" size="40" maxlength="100" value="<?php if (isset($_POST['address'])) echo $_POST['address']; ?>"  /> </p>
